...
| 저장소 / 사이트 | URL | 설명 |
| --- | --- | --- |
| anthropics/skills | https://github.com/anthropics/skills | 클로드 공식 스킬 저장소입니다. 창작, 개발, 기업, 문서 영역의 스킬을 확인할 수 있습니다. |
...
| 고급 12규칙 CLAUDE.md (Karpathy + 확장) | (내부 노트 / 옵시디언) | Karpathy 4규칙 + 2026년 5월 에이전트·다단계 작업 대응 8규칙 추가. 실수율 41% → 3% 검증. 토큰 예산, 체크포인트, 충돌 처리, "크게 실패하라" 등 실전 규칙 포함. |
...
| Notion Skills for Claude | https://www.notion.so/notiondevs/Notion-Skills-for-Claude-28da4445d27180c7af1df7d8615723d0 | 노션 공식 제공 클로드 스킬 모음입니다. |
