...
책 5장에서 만든 스킬을 같은 동작으로 재현해 두었습니다.

| 스킬 | 폴더 | 용도 |
| --- | --- | --- |
| 메모-할일-정리 | [chapters/ch05-스킬/메모-할일-정리/](../chapters/ch05-스킬/메모-할일-정리/SKILL.md) | 흩어진 메모를 마크다운 체크리스트로 정리 |
| 학습-보조 | [chapters/ch05-스킬/학습-보조/](../chapters/ch05-스킬/학습-보조/SKILL.md) | 비유 설명 → 배경 맞춤 예시 → 퀴즈로 이해도 확인 |
