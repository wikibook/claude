...
| 폴더 | 내용 | 책 연결 |
| --- | --- | --- |
| [`프롬프트/첫-작업-hello-claude.txt.md`](프롬프트/첫-작업-hello-claude.txt.md) | 첫 파일 생성 요청 | 7.2.4절 예제 7.1 |
| [`프롬프트/회의록-폴더-CLAUDE-md.md`](프롬프트/회의록-폴더-CLAUDE-md.md) | 폴더용 `CLAUDE.md`를 만드는 요청문 | 7.3.2절 예제 7.2 |
| [`회의록-폴더-예제/`](회의록-폴더-예제/CLAUDE.md) | 위 요청으로 만들어지는 `CLAUDE.md` + 샘플 회의록 | 7.3.2절 예제 7.2 |
| [`프롬프트/루틴-주간-회의-요약.md`](프롬프트/루틴-주간-회의-요약.md) | `/schedule` 루틴 설정 | 7.3.6절 예제 7.3 |
| [`포트폴리오/프롬프트.md`](포트폴리오/프롬프트.md) | 개인 포트폴리오 페이지 요청문(2턴) | 7.4.2절 예제 7.4 |
| [`프롬프트/파일정리-CSV병합.md`](프롬프트/파일정리-CSV병합.md) | CSV 병합 자동화 | 7.4.3절 예제 7.5 |
| [`프롬프트/이미지-일괄처리.md`](프롬프트/이미지-일괄처리.md) | 이미지 일괄 처리 → 스킬로 만들기 → 다시 부르기(3턴) | 7.5.1절 예제 7.6 |
| [`프로젝트-보드/프롬프트.md`](프로젝트-보드/프롬프트.md) | 칸반 보드·우선순위 색상 요청문 | 7.5.2절 예제 7.7 및 7.5.3절 후속 요청 |
