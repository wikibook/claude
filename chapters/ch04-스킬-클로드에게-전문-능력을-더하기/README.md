...
| 폴더 | 내용 | 책 연결 |
| --- | --- | --- |
| [`프롬프트/예제-프롬프트.md`](프롬프트/예제-프롬프트.md) | 예제 4.1~4.9 전체 [IN] 요청문 | 4.2~4.4절 예제 4.1~4.9 |
...
> 프롬프트 파일은 **요청문**, `SKILL.md`는 그 요청으로 만들어지는 **결과물**입니다.
> 스킬을 직접 만들어 보려면 `프롬프트/예제-프롬프트.md`의 4.2~4.5를 순서대로 보내 보세요.
