...
| 파일 | 내용 | 책 연결 |
| --- | --- | --- |
| [`디자인시스템-데일리핏.md`](디자인시스템-데일리핏.md) | 브랜드 디자인 시스템 설정 예시(색상·폰트) | 9.3.3절 예제 9.4 |

> 클로드 디자인의 결과물(홈페이지·슬라이드·인포그래픽)은 캔버스에서 생성되어 책에 코드로 실리지 않습니다.
> 저장소에는 재현 가능한 **디자인 시스템 설정**을 담았습니다.
