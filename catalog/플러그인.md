...
> 카피·CRO·런칭 스킬 보강: [Marketing Skills](https://github.com/coreyhaines31/marketingskills) — [겸용 도구](#커뮤니티-확장) 참고.
...
스킬과 플러그인 양쪽으로 설치·활용할 수 있는 도구입니다. 4장에서 배운 `SKILL.md` 구조가 실전에서 어떻게 확장되는지 비교해 보면 좋습니다.
...
| 도구 | 유형 | 설치 | 연계 장 |
| --- | --- | --- | --- |
| [obra/superpowers](https://github.com/obra/superpowers) | 스킬·플러그인 | `/plugin install superpowers@claude-plugins-official` | 4, 6, 7 |
| [mattpocock/skills](https://github.com/mattpocock/skills) | 스킬·플러그인 | `npx skills add mattpocock/skills`, `/setup-matt-pocock-skills` | 4, 7 |
| [garrytan/gstack](https://github.com/garrytan/gstack) | 스킬(슬래시 명령) | `~/.claude/skills/gstack`에 클론 후 `./setup` | 6, 7, 8 |
| [coreyhaines31/marketingskills](https://github.com/coreyhaines31/marketingskills) | 스킬·플러그인 | `npx skills add` 또는 `/plugin marketplace add` | 6, 8 |
| [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | 스킬·플러그인 | `/plugin marketplace add nextlevelbuilder/ui-ux-pro-max-skill` | 8 |
| [pbakaus/impeccable](https://github.com/pbakaus/impeccable) | 스킬·플러그인 | `/plugin marketplace add pbakaus/impeccable` | 8 |
| [zarazhangrui/frontend-slides](https://github.com/zarazhangrui/frontend-slides) | 스킬·플러그인 | `/plugin marketplace add https://github.com/zarazhangrui/frontend-slides` | 8 |
| [AgriciDaniel/claude-seo](https://github.com/AgriciDaniel/claude-seo) | 스킬·플러그인 | `/plugin marketplace add AgriciDaniel/claude-seo` | 6, 7, 8 |

> UI 품질·AI slop 제거: [Impeccable](https://impeccable.style/). 디자인 시스템: [UI UX Pro Max](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill). Cursor·Codex 등 다른 에이전트는 gstack `./setup --host <이름>`으로 설치합니다.
